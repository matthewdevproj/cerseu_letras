...
@section('content')
    ...
    <div class="card">
        <div class="p-6">
            <form action="{{ route('admin.docentes.store') }}" method="POST" data-avisar-sin-guardar enctype="multipart/form-data" id="form-docente"
                    ...
                    <div id="programas" x-show="tab === 'programas'" x-cloak>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            <div class="flex items-center gap-2 text-blue-800">
                                ...
                                <p class="text-sm font-medium">Seleccione los cursos y talleres donde participa este docente.</p>
                            </div>
                        </div>

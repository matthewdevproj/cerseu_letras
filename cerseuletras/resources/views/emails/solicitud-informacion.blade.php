...
<head>
    <meta charset="utf-8">
    <title>Nueva solicitud de información - Talleres</title>
</head>
<body style="font-family: Arial, sans-serif; color: #1f2937; background: #f9fafb; padding: 24px;">
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
        <div style="background: #143B63; color: #ffffff; padding: 20px 24px;">
            <h1 style="margin: 0; font-size: 18px;">Nueva solicitud de información — Talleres</h1>
        </div>
        <div style="padding: 24px;">
            <p style="margin: 0 0 16px;">Se ha registrado una nueva solicitud de información a través del portal de Talleres del CERSEU.</p>

            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                <tr>
                    <td style="padding: 8px 0; color: #6b7280; width: 160px;">Taller de interés</td>
            ...
            <p style="margin: 24px 0 0; font-size: 12px; color: #9ca3af;">
                Este correo fue generado automáticamente desde el formulario de solicitud de información de la página de Talleres.
            </p>
        </div>
    </div>
</body>

...
class InformativosSeeder extends Seeder
{
    public function run(): void
    {
        $informativos = [
            ...
            ['categoria' => 'Directiva', 'titulo' => 'Directiva de Modelo de Estructura de tesis Maestría y Doctorado | Modelo para el Doctorado en Comunicación, Periodismo y Medios digitales', 'tipo' => 0, 'url' => '#', 'orden' => 5],
            ...
            ['categoria' => 'Información', 'titulo' => 'PPT guía de Sustentación de Tesis', 'tipo' => 0, 'url' => '#', 'orden' => 4],
        ];

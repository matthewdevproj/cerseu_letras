...
@section('content')
    ...
    <a href="https://posgradoletras.unmsm.edu.pe/storage/documents/7JsBBeZHJcuqOXiI2MymlFwm5GfKPiIg6dYyetZQ.pdf"
        target="_blank"
        class="btn btn-success btn-lg gap-3 px-8 py-5 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all">
    ...
    <p class="text-sm text-gray-500 mt-4">Clic en el botón para acceder al formulario de envío</p>
</div>

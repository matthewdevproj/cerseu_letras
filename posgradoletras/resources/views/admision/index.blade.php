            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-md space-y-6">
                ...
                <div>
                    ...
                    <a href="https://posgradoletras.unmsm.edu.pe/storage/documents/7JsBBeZHJcuqOXiI2MymlFwm5GfKPiIg6dYyetZQ.pdf"
                        target="_blank"
                        class="inline-flex items-center gap-3 px-8 py-5 bg-gradient-to-r from-green-700 to-green-800 text-white font-bold text-lg rounded-2xl hover:from-green-800 hover:to-green-900 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 w-full md:w-auto justify-center group">

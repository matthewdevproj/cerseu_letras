...
@section('content')
    <div class="page-header">
        <h1>Autoridades</h1>
        <p>Conoce a las autoridades del CERSEU</p>
    </div>
            ...
            @foreach($autoridades as $autoridad)
                <div class="card">
                    <div style="text-align: center; margin-bottom: 1rem;">
                        <div
                            style="width: 120px; height: 120px; background: linear-gradient(135deg, #103050 0%, #B6A350 100%); border-radius: 50%; margin: 0 auto 1rem; display: flex; align-items: center; justify-content: center; color: white; font-size: 2.5rem; font-weight: bold;">
                            {{ strtoupper(substr($autoridad['nombre'], 0, 1)) }}
                        </div>
                    </div>

                    <h3 style="color: #103050; text-align: center; margin-bottom: 0.5rem;">{{ $autoridad['cargo'] }}</h3>
                    ...
                    <div style="background: #f9f9f9; padding: 1rem; border-radius: 8px;">
                        <p><strong>Email:</strong> <a href="mailto:{{ $autoridad['email'] }}"
                                style="color: #103050;">{{ $autoridad['email'] }}</a></p>

...
@section('content')
    <div class="page-header">
        <div style="display: flex; align-items: center; gap: 2rem;">
            <div
                style="width: 150px; height: 150px; background: linear-gradient(135deg, #103050 0%, #B6A350 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 3rem; font-weight: bold; flex-shrink: 0;">
            ...
            <div>
                ...
                <p><a href="mailto:{{ $profesor['email'] }}" style="color: #103050;">{{ $profesor['email'] }}</a></p>
            </div>
        </div>
    </div>

    <div class="card">
        <h2 style="color: #103050; margin-bottom: 1rem;">Biografía</h2>
    ...
    @if(isset($profesor['lineas_investigacion']) && count($profesor['lineas_investigacion']) > 0)
        <div class="card">
            <h2 style="color: #103050; margin-bottom: 1rem;">Líneas de Investigación</h2>
    ...
    @if(isset($profesor['programas']) && count($profesor['programas']) > 0)
        <div class="card">
            <h2 style="color: #103050; margin-bottom: 1rem;">Cursos en los que Participa</h2>
                ...
                @foreach($profesor['programas'] as $programaSlug)
                    ...
                    @if($programa)
                        <div style="background: #f9f9f9; padding: 1rem; border-radius: 8px; border-left: 4px solid #B6A350;">
                            ...
                            <a href="{{ $programa->url }}" style="color: #103050;">Ver curso →</a>
                        </div>
                    @endif
                @endforeach
            </div>
    ...
    <div class="card">
        <h2 style="color: #103050; margin-bottom: 1rem;">Enlaces Externos</h2>

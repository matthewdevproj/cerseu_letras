                ...
                <div class="tab-content">
                    ...
                    <div id="contenido" class="tab-pane hidden">
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="descripcion" class="form-label block text-xs font-bold text-gray-600 uppercase mb-2">Descripción</label>
                                <textarea name="descripcion" id="descripcion" rows="4"
                                    class="block w-full py-2.5 px-4 border border-gray-300 rounded-lg"
                                    placeholder="Descripción detallada...">{{ old('descripcion') }}</textarea>
                            </div>
                            <div>
                                <label for="presentacion" class="form-label block text-xs font-bold text-gray-600 uppercase mb-2">Presentación</label>
                                <textarea name="presentacion" id="presentacion" rows="4"
                                    class="block w-full py-2.5 px-4 border border-gray-300 rounded-lg"
                                    placeholder="Presentación del programa...">{{ old('presentacion') }}</textarea>
                            </div>
                            <div>
                            ...
                            <div>
                                <label for="perfil_egresado" class="form-label block text-xs font-bold text-gray-600 uppercase mb-2">Perfil del Egresado</label>
                                <textarea name="perfil_egresado" id="perfil_egresado" rows="4"
                                    class="block w-full py-2.5 px-4 border border-gray-300 rounded-lg"
                                    placeholder="Competencias del egresado...">{{ old('perfil_egresado') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="config" class="tab-pane hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="plan_url" class="form-label block text-xs font-bold text-gray-600 uppercase mb-2">URL Plan de Estudios (PDF)</label>
                                <input type="url" name="plan_url" id="plan_url" value="{{ old('plan_url') }}"
                                    class="block w-full py-2.5 px-4 border border-gray-300 rounded-lg"
                                    placeholder="https://ejemplo.com/plan.pdf">
                            </div>
                            <div>
                                <label for="imagen" class="form-label block text-xs font-bold text-gray-600 uppercase mb-2">Imagen</label>
                                <input type="file" name="imagen" id="imagen" accept="image/*"
                                    class="block w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:bg-brand-gold file:text-white hover:file:bg-yellow-600">

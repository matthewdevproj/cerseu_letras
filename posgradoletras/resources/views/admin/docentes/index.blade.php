...
<script>
    function openDeleteModal(id, nombre) {
        document.getElementById('deleteForm').action = '/admin/docentes/' + id;
        document.getElementById('deleteModalMessage').innerHTML = '¿Estás seguro de eliminar a <strong>"' + nombre + '"</strong>? Esta acción no se puede deshacer.';

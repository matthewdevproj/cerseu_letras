        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    ...
                    {{ $docente->programas->count() }} programa(s) asociado(s)
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="tab-content">
                    ...
                    <div id="programas" class="tab-pane hidden">
                        ...
                        @if($docente->programas->count() > 0)
                            <h4 class="text-sm font-bold text-gray-700 uppercase mb-4">Programas donde participa este docente:</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach($docente->programas as $programa)
                                    <div class="flex items-center p-4 bg-gray-50 border border-gray-200 rounded-lg">
                                        <div class="w-10 h-10 rounded-lg bg-brand-red/10 flex items-center justify-center text-brand-red mr-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            @if($programa->pivot->es_coordinador)
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-brand-gold text-white mt-1">
                                                    Coordinador
                                                </span>
                                            @endif
                                            @if($programa->pivot->rol)
                                                <span class="text-xs text-gray-600 block mt-1">{{ $programa->pivot->rol }}</span>
                                            @endif
                                        </div>
                                        <a href="{{ route('admin.programas.edit', $programa) }}" 
                                           class="text-gray-400 hover:text-brand-red transition-colors" title="Editar programa">

...
@section('content')
    ...
    <section class="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center bg-gray-900 overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-50">
            <img src="https://images.unsplash.com/photo-1497633762265-9d179a990aa6?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
                alt="Biblioteca" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 text-center text-white px-4 mt-20">
            <p class="text-unmsm-dorado font-bold tracking-widest uppercase text-sm mb-3">Oferta Académica 2025</p>
            <h1 class="text-4xl md:text-6xl font-serif font-bold mb-6 drop-shadow-lg">Nuestros Programas</h1>
            <p class="text-gray-200 max-w-2xl mx-auto font-light text-lg leading-relaxed">
                Especialízate con la excelencia académica de la Decana de América y transforma tu futuro profesional.
            </p>
        </div>
    </section>
